...
// Updated version on 2025‑09‑07 after adding new items and refreshing lastSeen dates
...
const fallbackData = [
  // Provide an image for the Basic Purple Flashlight to match the updated artwork
  { name: "Basic Purple Flashlight", lastSeen: "2025-09-08", price: 499, image: "BasicPurpleFlashlight.png" },
  ...
  { name: "Basic Pink Lockpick", lastSeen: "2025-09-19", price: 499, image: "BasicPinkLockpick.png" },
  { name: "Basic Blue Shears", lastSeen: "2025-09-18", price: 499 },
  { name: "Basic Green Shears", lastSeen: "2025-09-16", price: 499 },
  { name: "Basic Cyan Shears", lastSeen: "2025-09-19", price: 499 },
  { name: "Basic Magenta Bulklight", lastSeen: "2025-09-19", price: 499, image: "BasicMagentaBulklight.png" },
  { name: "Basic Orange Bulklight", lastSeen: "2025-09-12", price: 499, image: "BasicOrangeBulklight.png" },
  { name: "Basic Pink Bulklight", lastSeen: "2025-09-08", price: 499, image: "BasicPinkBulklight.png" },
  { name: "Basic Cyan Bulklight", lastSeen: "2025-09-15", price: 499, image: "BasicCyanBulklight.png" },
  { name: "Basic Blue Straplight", lastSeen: "2025-09-13", price: 499 },
  { name: "Basic Cyan Straplight", lastSeen: "2025-09-10", price: 499 },
  ...
  { name: "Basic Orange Vitamins", lastSeen: "2025-09-06", price: 499 },
  { name: "Basic Black Lighter", lastSeen: "2025-08-22", price: 499, image: "BasicBlackLighter.png" },
  { name: "Basic Green Lighter", lastSeen: "2025-09-17", price: 499, image: "BasicGreenLighter.png" },
  ...
  { name: "Basic Yellow Lighter", lastSeen: "2025-09-15", price: 499, image: "BasicYellowLighter.png" },
  { name: "Basic Pink Lighter", lastSeen: "2025-09-27", price: 499, image: "BasicPinkLighter.png" },
  ...
  // Added Basic Yellow Shakelight on 2025-09-16 with no image provided
  { name: "Basic Yellow Shakelight", lastSeen: "2025-09-16", price: 799 },
  { name: "Camo Vitamins", lastSeen: "2025-08-19", price: 799 },
  { name: "Color Camo Vitamins", lastSeen: "2025-09-06", price: 799 },
  { name: "Color Camo Bulklight", lastSeen: "2025-09-28", price: 799, image: "ColorCamoBulklight.png" },
 ...
 { name: "Hallowed Crucifix", lastSeen: "2025-09-07", price: 1499, image: "HallowedCrucifix.png" },
  { name: "Loca Cola Gween Soda", lastSeen: "2025-09-19", price: 1499, image: "LocaColaGweenSoda.png" },
  ...
  { name: "3rd Anniversary Candle", lastSeen: "2025-09-26", price: "3 (3rd Anniversary Bundle)", image: "3rdAnniversaryCandle.png" },
  { name: "3rd Anniversary Crucifix", lastSeen: "2025-09-26", price: "3 (3rd Anniversary Bundle)", image: "3rdAnniversaryCrucifix.png" },
  { name: "3rd Anniversary Flashlight", lastSeen: "2025-09-26", price: "3 (3rd Anniversary Bundle)", image: "3rdAnniversaryFlashlight.png" },
  { name: "3rd Anniversary Moonlight Candle", lastSeen: "2025-09-26", price: "3 (3rd Anniversary Bundle)" },
 { name: "Ban Hammer Crucifix", lastSeen: "2025-08-21", price: "3999 (Classic Gear Bundle)", image: "BanHammerCrucifix.png" },
  ...
  { name: "Overgrown Alarm Clock", lastSeen: "2025-09-26", price: "3999 (Overgrown Bundle)", image: "OvergrownAlarmClock.png" },
  { name: "Overgrown Crucifix", lastSeen: "2025-09-26", price: "3999 (Overgrown Bundle)", image: "OvergrownCrucifix.png" },
  { name: "Overgrown Flashlight", lastSeen: "2025-09-26", price: "3999 (Overgrown Bundle)", image: "OvergrownFlashlight.png" },
  { name: "Overgrown Smoothie", lastSeen: "2025-09-26", price: "3999 (Overgrown Bundle)" },
  ...
  // Added fallback for Gloombat Glowstick with its new image
  { name: "Gloombat Glowstick", lastSeen: "2025-09-08", price: 1499, image: "GloombatGlowstick.png" },
  { name: "Voxel Gween Soda", lastSeen: "2025-08-28", price: "4999 (Voxel Bundle)", image: "VoxelGweenSoda.png" },
  ...
  { name: "Makeshift Vitamins", lastSeen: "2025-09-19", price: 1499 },
  ...
  { name: "Basic Black Vitamins", lastSeen: "2025-09-28", price: 499 },
  ...
  { name: "Happy Sip Smoothie", lastSeen: "2025-09-17", price: 1499 },
  // Basic Orange Shears has its image embedded directly in data.json
  { name: "Basic Orange Shears", lastSeen: "2025-08-28", price: 499 },
  { name: "Basic Red Bulklight", lastSeen: "2025-09-27", price: 499, image: "BasicRedBulklight.png" },
  { name: "Basic Purple Lighter", lastSeen: "2025-09-28", price: 499, image: "BasicPurpleLighter.png" },
  { name: "Basic Magenta Flashlight", lastSeen: "2025-09-10", price: 499, image: "BasicMagentaFlashlight.png" },
  ...
  { name: "Basic Pink Straplight", lastSeen: "2025-09-16", price: 499 },
  { name: "Basic Jade Flashlight", lastSeen: "2025-09-27", price: 499, image: "BasicJadeFlashlight.png" },
  ...
  { name: "Retro Crucifix", lastSeen: "2025-09-26", price: "1499 (Retro Bundle)", image: "RetroCrucifix.png" },
  { name: "Retro Flashlight", lastSeen: "2025-09-26", price: "1499 (Retro Bundle)", image: "RetroFlashlight.png" },
  { name: "Retro Gween Soda", lastSeen: "2025-09-26", price: "1499 (Retro Bundle)", image: "RetroGweenSoda.png" },
  ...
  { name: "Basic Cyan Flashlight", lastSeen: "2025-09-12", price: 499, image: "BasicCyanFlashlight.png" },
  { name: "Basic Orange Flashlight", lastSeen: "2025-09-06", price: 499, image: "BasicOrangeFlashlight.png" },
  { name: "Transluscent Crucifix", lastSeen: "2025-09-28", price: 799, image: "TransluscentCrucifix.png" }
  ,
  // Newly added items on 2025‑08‑31 (vitamins)
  { name: "Basic Jade Vitamins", lastSeen: "2025-09-27", price: 499 },
  { name: "Basic Magenta Vitamins", lastSeen: "2025-09-17", price: 499 },
  // Newly added items on 2025-09-01
  { name: "Basic Red Straplight", lastSeen: "2025-09-01", price: 499 },
  { name: "Basic Black Shakelight", lastSeen: "2025-09-01", price: 799 },
  // Newly added items on 2025-09-02
  { name: "Basic Red Lockpick", lastSeen: "2025-09-02", price: 499 },
  { name: "Basic Blue Lighter", lastSeen: "2025-09-19", price: 499 },
  { name: "Basic Magenta Shears", lastSeen: "2025-09-11", price: 499 }
  ,
  // Newly added items on 2025-09-03
  { name: "Basic Purple Shears", lastSeen: "2025-09-27", price: 499 },
  { name: "Basic Pink Shears", lastSeen: "2025-09-05", price: 499 },
  { name: "Transluscent Vitamins", lastSeen: "2025-09-17", price: 799, image: "TransluscentVitamins.png" },
  { name: "Basic Black Flashlight", lastSeen: "2025-09-12", price: 499, image: "BasicBlackFlashlight.png" },
  { name: "Basic Black Bulklight", lastSeen: "2025-09-03", price: 499, image: "BasicBlackBulklight.png" },
  { name: "Basic Purple Lockpick", lastSeen: "2025-09-14", price: 499, image: "BasicPurpleLockpick.png" },
  // Newly added items on 2025-09-04
  { name: "Basic Green Vitamins", lastSeen: "2025-09-04", price: 499, image: "BasicGreenVitamins.png" },
  { name: "Basic Red Flashlight", lastSeen: "2025-09-14", price: 499, image: "BasicRedFlashlight.png" },
  { name: "Basic Jade Bulklight", lastSeen: "2025-09-14", price: 499, image: "BasicJadeBulklight.png" }
  , { name: "Transluscent Shears", lastSeen: "2025-09-12", price: 799, image: "TransluscentShears.png" },
  // Newly added items on 2025-09-06
  { name: "Basic Blue Flashlight", lastSeen: "2025-09-06", price: 499, image: "BasicBlueFlashlight.png" },
  { name: "Basic Magenta Lockpick", lastSeen: "2025-09-15", price: 499, image: "BasicMagentaLockpick.png" },
  ...
  { name: "Basic White Bulklight", lastSeen: "2025-09-28", price: 499, image: "BasicWhiteBulklight.png" },
  { name: "Camo Bulklight", lastSeen: "2025-09-17", price: 799, image: "CamoBulklight.png" },
  { name: "Basic Green Flashlight", lastSeen: "2025-09-16", price: 499, image: "BasicGreenFlashlight.png" },
  { name: "Color Camo Flashlight", lastSeen: "2025-09-10", price: 799, image: "ColorCamoFlashlight.png" }
  ,
  // Newly added item on 2025-09-11
  { name: "Basic Yellow Flashlight", lastSeen: "2025-09-11", price: 499, image: "BasicYellowFlashlight.png" },
  // Newly added item on 2025-09-12
  { name: "Basic Yellow Shears", lastSeen: "2025-09-12", price: 499, image: "BasicYellowShears.png" },
  // Newly added items on 2025-09-13
  { name: "Color Camo Shears", lastSeen: "2025-09-13", price: 799, image: "ColorCamoShears.png" },
  { name: "Color Camo Straplight", lastSeen: "2025-09-13", price: 799, image: "ColorCamoStraplight.png" },
  // Newly added items on 2025-09-14
  { name: "Basic Cyan Lockpick", lastSeen: "2025-09-14", price: 499, image: "BasicCyanLockpick.png" },
  { name: "Camo Shears", lastSeen: "2025-09-14", price: 799, image: "CamoShears.png" },
  { name: "Basic Black Shears", lastSeen: "2025-09-14", price: 499 },
  // Newly added item on 2025-09-16
  ...
  { name: "Powerup Flashlight", lastSeen: "2025-09-28", price: "2499 (Powerup Bundle)", image: "PowerupFlashlight.png" },
  { name: "Powerup Gold Blaster", lastSeen: "2025-09-28", price: "2499 (Powerup Bundle)", image: "PowerupGoldBlaster.png" },
  { name: "Holy Handgun Gold Blaster", lastSeen: "2025-09-28", price: 2999, image: "HolyHandgunGoldBlaster.png" },
  { name: "Crayons Bandage Pack", lastSeen: "2025-09-28", price: 799, image: "CrayonsBandagePack.png" },
  { name: "Basic Red Shears", lastSeen: "2025-09-28", price: 499, image: "BasicRedShears.png" },
  { name: "L Crucifix", lastSeen: "2025-09-28", price: 1499, image: "LCrucifix.png" }
];
...
function getItemType(name) {
  ...
  // New categories for special items
  if (lower.includes('gold blaster')) return 'Gold Blaster';
  if (lower.includes('bandage pack')) return 'Bandage Pack';
...
function createItemCard(item) {
  ...
  // Removed the permanent removal note for 3rd Anniversary items.
